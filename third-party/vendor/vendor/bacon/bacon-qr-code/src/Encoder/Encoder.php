...
namespace WPSEC_Vendor\BaconQrCode\Encoder;

use WPSEC_Vendor\BaconQrCode\Common\BitArray;
use WPSEC_Vendor\BaconQrCode\Common\CharacterSetEci;
use WPSEC_Vendor\BaconQrCode\Common\ErrorCorrectionLevel;
use WPSEC_Vendor\BaconQrCode\Common\Mode;
use WPSEC_Vendor\BaconQrCode\Common\ReedSolomonCodec;
use WPSEC_Vendor\BaconQrCode\Common\Version;
use WPSEC_Vendor\BaconQrCode\Exception\WriterException;
use SplFixedArray;
/**
 * Encoder.
 * @internal
