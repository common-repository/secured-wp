 ...
 */
namespace WPSEC_Vendor\Composer\Autoload;
...
class ClassLoader
{
    ...
    public function getPrefixes()
    {
        if (!empty($this->prefixesPsr0)) {
            return \call_user_func_array('WPSEC_Vendor\\array_merge', \array_values($this->prefixesPsr0));
        }
        return array();
    }
    /**
    ...
    public function findFile($class)
    {
        ...
        if (\false === $file && \defined('WPSEC_Vendor\\HHVM_VERSION')) {
