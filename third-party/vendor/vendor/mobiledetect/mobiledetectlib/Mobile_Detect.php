...
class Mobile_Detect
{
    ...
    protected static $browsers = array(
        ...
        //'Midori'          => 'midori',
        //'Tizen'           => 'Tizen',
        'WeChat' => 'WPSEC_Vendor\\bMicroMessenger\\b',
        ...
        'Mercury' => 'WPSEC_Vendor\\bMercury\\b',
    ...
    public static function getMobileDetectionRules()
    {
        static $rules;
        if (!$rules) {
            $rules = \array_merge(self::getPhoneDevices(), self::getTabletDevices(), self::getOperatingSystems(), self::getBrowsers());
        }
        return $rules;
    }
    /**
    ...
    public function getMobileDetectionRulesExtended()
    {
        ...
        if (!$rules) {
            ...
            $rules = \array_merge(static::getPhoneDevices(), static::getTabletDevices(), static::getOperatingSystems(), static::getBrowsers(), static::getUtilities());
        }
        return $rules;
    }
    /**
